...
<script language="Javascript" src="Questionnaire2/form.js"></script>
<link rel="stylesheet" type="text/css" href="Questionnaire2/style.css">
</head>
...
<div align="center"><br>
  <br>
  <p class="title"><strong>SIMILARITY OF LANGUAGES 2:  CONSENT  AND  QUESTIONNAIRE</strong></p>
        <FORM METHOD="post" ACTION="/MTurk/Pros/univ/trial/Questionnaire2/done.php">

          <div class="disclaimer">This study is being conducted by researchers at the Massachusetts Institute of Technology.</div>
          <br>

          <div class="warning"> <b style="color:red"> Please only complete this study "Similarity of Languages 2" once </b>. You will not be paid for retakes. If you have already completed this study and submit it again, all submissions but the first will be rejected, and you will only be paid for the first submission. Having a submission rejected is detrimental to your reputation on Prolific, and may prevent you from participating in studies in the future.</div>
